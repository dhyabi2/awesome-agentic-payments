...
| **Nano (XNO) — feeless rail**                   | Distributed-ledger settlement native to the network: 0 fee per transaction, ~sub-second finality, self-custodied peer-to-peer with no issuer that can freeze funds. An exact-scheme x402 settlement leg exists on `nano:mainnet` ([x402nano/exact](https://github.com/x402nano/exact), [x402nano/facilitator](https://github.com/x402nano/facilitator)); a Python counterpart ships in [pursekeeper/x402-nano-exact](https://github.com/pursekeeper/x402-nano-exact). |
